...
<!-- Mirrored from www.radiustheme.com/demo/html/psdboss/akkhor/akkhor/all-subject.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 13 Oct 2022 18:57:02 GMT -->
            ...
            <div class="sidebar-main sidebar-menu-one sidebar-expand-md sidebar-color">
                ...
                <div class="sidebar-menu-content">
                    <ul class="nav nav-sidebar-menu sidebar-toggle-view">
                        ...
                        <li class="nav-item">
                            <a href="all-subject.html" class="nav-link menu-active"><i class="flaticon-open-book"></i><span class="menu-active">Subject</span></a>
                        </li>
                        <li class="nav-item">
